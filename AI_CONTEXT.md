...
| `volgaHelpCopied` | content-volgahelp.js | Текст комментария → `volgaHelpPastePending` в storage |
...
| `content-ttm.js` | 1200+ | Кнопки toolbar, автопоиск, таймер, конструктор комментариев |
| `content-volgahelp.js` | 200+ | Черновики volgahelp по номеру заявки, перехват «Скопировать всё» |
...
Версии в Sheets пишутся как `v0.7.0` (иначе Sheets парсит `0.7.0` как дату).
...
| `volgaHelpSession` | content-ttm | content-volgahelp | Активная сессия конструктора (ticket + editor) |
| `volgaHelpDrafts` | content-volgahelp | content-volgahelp | Черновики формы по номеру заявки |
| `volgaHelpPastePending` | background | content-ttm | Сигнал вставки текста в Quill |
