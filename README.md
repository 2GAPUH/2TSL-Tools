...
|------|---------|-----------|
| `omnichat/*` | `omnichat.rt.ru` | Вкладка «Дополнительно»; автолинковка НЛС/заявок; кнопка вверх к «Обращение создано» |
...
| `omnichatScrollToAppeal` | ✅ | Кнопка вверх в чате → блоки «Обращение #… создано» |
